...
ActiveRecord::Schema.define(:version => 20130420093236) do
  ...
  add_index "problems", ["account_id"], :name => "index_problems_on_account_id"
  ...
  add_index "routes", ["problem_id"], :name => "index_routes_on_problem_id"
