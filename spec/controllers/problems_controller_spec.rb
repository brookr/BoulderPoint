  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved problem as @problem" do
        ...
        post :create, {:problem => { "account" => "invalid value" }}, valid_session
        assigns(:problem).should be_a_new(Problem)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested problem" do
        ...
        Problem.any_instance.should_receive(:update_attributes).with({ "account" => "" })
        put :update, {:id => problem.to_param, :problem => { "account" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the problem as @problem" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Problem.any_instance.stub(:save).and_return(false)
        put :update, {:id => problem.to_param, :problem => { "account" => "invalid value" }}, valid_session
        assigns(:problem).should eq(problem)
      end
